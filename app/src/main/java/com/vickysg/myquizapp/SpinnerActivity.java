...
import com.vickysg.myquizapp.SpinWheel.LuckyWheelView;
import com.vickysg.myquizapp.SpinWheel.model.LuckyItem;
import com.vickysg.myquizapp.databinding.ActivitySpinnerBinding;
...
public class SpinnerActivity extends AppCompatActivity {
    ...
    void updateCash(int index) {
        ...
        final long money = cash ;


        if (user.isAnonymous()){
            Toast.makeText(this, "Please Login Your Account to Adding Coins in Wallet and Earn Rewards", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(SpinnerActivity.this, money + " Coins Successfully added in Your Account account.", Toast.LENGTH_LONG).show();
